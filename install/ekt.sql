...
--
-- Current Database: `ekt`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `ekt_1` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `ekt_1`;

--
-- Table structure for table `ec_logs`
--

DROP TABLE IF EXISTS `ec_logs`;
...
--
-- Table structure for table `est_address_book`
--

DROP TABLE IF EXISTS `est_address_book`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_anns`
--

DROP TABLE IF EXISTS `est_anns`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_backup`
--

DROP TABLE IF EXISTS `est_backup`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_cdr`
--

DROP TABLE IF EXISTS `est_cdr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `est_cdr` (
  ...
  `call_id` int(10) unsigned NOT NULL COMMENT '通话ID',
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `statistics_stage` AFTER INSERT ON `est_cdr` FOR EACH ROW BEGIN
IF NEW.user_id!=0
THEN
IF NEW.conn_secs=0
THEN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `cle_set_first_connect_time` BEFORE UPDATE ON `est_client` FOR EACH ROW BEGIN
IF NEW.cle_last_connecttime != '0000-00-00' 
THEN

IF  OLD.cle_first_connecttime = '0000-00-00' 
THEN
SET NEW.cle_first_connecttime = NEW.cle_last_connecttime;
END IF;
IF  NEW.con_rec_next_time = '0000-00-00'  AND OLD.con_rec_next_time != '0000-00-00'  
THEN
IF NEW.cle_last_connecttime >= OLD.con_rec_next_time 
THEN 
SET NEW.con_rec_next_time = '0000-00-00';
ELSE
...
--
-- Table structure for table `est_client_history`
--
...
CREATE TABLE `est_client_history` (
  `cle_id` int(11) NOT NULL COMMENT '客户ID，主键',
...
--
-- Table structure for table `est_client_log`
--

DROP TABLE IF EXISTS `est_client_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_client_type`
--

DROP TABLE IF EXISTS `est_client_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_config`
--

DROP TABLE IF EXISTS `est_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `est_config` (
  ...
  `client_has_create_day` int(11) NOT NULL COMMENT '自动收回临界点(即数据从创建到现在的时间) 单位:天',
  `no_contact_day1` int(11) NOT NULL COMMENT '临界点内没联系的天数 或 方案一没联系的天数',
  `no_contact_day2` int(11) NOT NULL COMMENT '临界点以外没联系的天数',
  `use_history` int(11) NOT NULL DEFAULT '0' COMMENT '是否启用历史信息 0否 1是',
  `created_day` int(11) NOT NULL COMMENT '历史信息临界点(即数据数据被创建到今的天数)',
...
('公司名称', 0, 0, 2, 1, 1, 'swf', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `est_contact`
--

DROP TABLE IF EXISTS `est_contact`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `est_contact` (
  ...
  `con_2` varchar(50) NOT NULL DEFAULT '' COMMENT '配置字段2',
...
--
-- Table structure for table `est_contact_record`
--

DROP TABLE IF EXISTS `est_contact_record`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `est_contact_record` (
  ...
  `con_rec_next_time` date NOT NULL COMMENT '下次联系时间',
  `callid` int(11) NOT NULL DEFAULT '0' COMMENT '录音ID',
  `cle_id` int(11) NOT NULL DEFAULT '0' COMMENT '客户ID',
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `insert_update_client` AFTER INSERT ON `est_contact_record` FOR EACH ROW BEGIN
IF   NEW.con_rec_time != '0000-00-00 00:00:00'  AND  NEW.cle_id > 0 
THEN
UPDATE est_client SET cle_last_connecttime = DATE(NEW.con_rec_time),con_rec_next_time = NEW.con_rec_next_time WHERE cle_id = NEW.cle_id;
END IF;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `update_update_client` AFTER UPDATE ON `est_contact_record` FOR EACH ROW BEGIN
IF   NEW.con_rec_time != '0000-00-00 00:00:00'  AND  NEW.cle_id > 0 
THEN
UPDATE est_client SET cle_last_connecttime = DATE(NEW.con_rec_time),con_rec_next_time = NEW.con_rec_next_time WHERE cle_id = NEW.cle_id;
END IF;
...
--
-- Table structure for table `est_custom_menu`
--

DROP TABLE IF EXISTS `est_custom_menu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `est_custom_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='自定义菜单表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `est_department`
--

DROP TABLE IF EXISTS `est_department`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- 转存表中的数据 `est_department`
--

INSERT INTO `est_department` (`dept_id`, `dept_pid`, `dept_name`, `dept_deep`) VALUES
(1, 0, '公司', 1);

-- --------------------------------------------------------

--
-- Table structure for table `est_dictionary`
--

DROP TABLE IF EXISTS `est_dictionary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_dictionary_detail`
--

DROP TABLE IF EXISTS `est_dictionary_detail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
DROP TABLE IF EXISTS `est_fields`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `est_fields` (
  ...
  `datefmt`  varchar(30) NOT NULL COMMENT '日期格式',
  PRIMARY KEY (`id`),
  KEY `field_type` (`field_type`)
) ENGINE=InnoDB AUTO_INCREMENT=120 DEFAULT CHARSET=utf8 COMMENT='字段表（自定义字段、常规字段）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(6, '信息来源', 'cle_info_source', 0, 0, 1, 0, 70),
...
--
-- Table structure for table `est_fields_detail`
--

DROP TABLE IF EXISTS `est_fields_detail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_fields_jl`
--

DROP TABLE IF EXISTS `est_fields_jl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_file`
--

DROP TABLE IF EXISTS `est_file`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_flow`
--

DROP TABLE IF EXISTS `est_flow`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_flow_detail`
--

DROP TABLE IF EXISTS `est_flow_detail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_flow_nodes`
--

DROP TABLE IF EXISTS `est_flow_nodes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_form`
--

DROP TABLE IF EXISTS `est_form`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_form_cascade`
--

DROP TABLE IF EXISTS `est_form_cascade`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_form_fields`
--

DROP TABLE IF EXISTS `est_form_fields`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_import_error_data`
--

DROP TABLE IF EXISTS `est_import_error_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_import_log`
--

DROP TABLE IF EXISTS `est_import_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `est_import_log` (
  ...
  PRIMARY KEY (`impt_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='数据导入日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `est_knowledge_article`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
DROP TABLE IF EXISTS `est_knowledge_class`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='知识库分类表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- 转存表中的数据 `est_knowledge_class`
--

INSERT INTO `est_knowledge_class` (`k_class_id`, `k_class_pid`, `k_class_name`, `k_class_deep`, `k_class_name_link`, `k_class_sort`) VALUES
(1, 0, '知识库', 0, '0,1,', 1);

-- --------------------------------------------------------

--
-- Table structure for table `est_lost_cdr`
--

DROP TABLE IF EXISTS `est_lost_cdr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `statistics_lost_cdr` AFTER INSERT ON `est_lost_cdr` FOR EACH ROW BEGIN
IF NEW.caller!=''
THEN
IF NEW.user_id!=0
THEN
...
--
-- Table structure for table `est_message`
--

DROP TABLE IF EXISTS `est_message`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_model`
--

DROP TABLE IF EXISTS `est_model`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_oper_log`
--

DROP TABLE IF EXISTS `est_oper_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_order`
--

DROP TABLE IF EXISTS `est_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `est_order` (
  ...
  `order_1` varchar(50) NOT NULL DEFAULT '',
...
--
-- Table structure for table `est_order_log`
--

DROP TABLE IF EXISTS `est_order_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_order_product`
--

DROP TABLE IF EXISTS `est_order_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_product`
--

DROP TABLE IF EXISTS `est_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `est_product` (
  ...
  `product_4` varchar(50) DEFAULT '' COMMENT '配置字段4',
...
--
-- Table structure for table `est_product_class`
--

DROP TABLE IF EXISTS `est_product_class`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- 转存表中的数据 `est_product_class`
--

INSERT INTO `est_product_class` (`p_c_id`, `p_c_pid`, `p_c_name`, `p_c_pname`, `p_c_deep`) VALUES
(1, 0, '产品分类', '产品分类', 1);

-- --------------------------------------------------------

--
-- Table structure for table `est_queue`
--

DROP TABLE IF EXISTS `est_queue`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
DROP TABLE IF EXISTS `est_remind`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='提醒表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `est_role`
--

DROP TABLE IF EXISTS `est_role`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
INSERT INTO `est_role` (`role_id`, `role_name`, `role_action_list`, `role_type`) VALUES
(1, 'BOSS', 'all', 1),
(2, '管理员', 'consult,transfer,threeway,khglxygl,khglzytp,khgldataimport,power_add,power_update,power_delete,power_release,power_export,wdzswdxx,wdzswdtu,wdzthjl,wdzswjldgl,smsrecords,massmessage,smsmodelmanage,sendsms,cpflgl,cpgllb,pltjcp,tjfxzhsjtjfx,ddgllb,order_update_power,order_delete_power,order_output_power,slgd,gdgllb,xtgljsgl,xtglbmgl,xtglyhgl,extent_power,', 1),
(3, '组长', 'consult,transfer,threeway,khglxygl,khgldataimport,power_add,power_update,power_delete,power_export,wdzswdxx,wdzswdtu,wdzthjl,wdzswjldgl,power_callrecord,smsrecords,massmessage,smsmodelmanage,sendsms,slgd,gdgllb,accept_wf,send_wf,revisit_wf,finish_wf,', 2),
(4, '坐席', 'consult,transfer,threeway,khglxygl,khgldataimport,power_add,power_update,power_delete,power_release,power_export,wdzswdxx,wdzswdtu,wdzthjl,wdzswjldgl,power_callrecord,smsrecords,massmessage,sendsms,slgd,gdgllb,accept_wf,send_wf,revisit_wf,finish_wf,', 2);
...
CREATE TABLE `est_service` (
  ...
  `serv_2` varchar(50) NOT NULL DEFAULT '',
  `serv_3` varchar(50) NOT NULL DEFAULT '',
  `serv_4` varchar(50) NOT NULL DEFAULT '',
  ...
  `call_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '呼叫ID',
  PRIMARY KEY (`serv_id`),
  KEY `cle_id` (`cle_id`)
...
DROP TABLE IF EXISTS `est_smsmodel`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_statistics_lost_cdr`
--

DROP TABLE IF EXISTS `est_statistics_lost_cdr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_statistics_stage`
--

DROP TABLE IF EXISTS `est_statistics_stage`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `est_users`
--
...
--
-- Table structure for table `est_work_flow`
--

DROP TABLE IF EXISTS `est_work_flow`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping routines for database 'ekt'
--
...
-- Dump completed on 2014-04-18  9:52:53
