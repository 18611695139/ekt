                ...
                children: [
    				...
    				children: [
    					...
    					setup: function( name, element ) {
                            if ( name == 'clear' )
                                ...
                                this.setValue( element.data( 'cke-saved-sqlOptName' ) || element.getAttribute( 'sqlOptName' ) || '' );
        					}
    					},
    					commit: function( element ) {
    						if ( this.getValue() )
    							element.setAttribute( 'sqlOptName', this.getValue() );
    						else
    							element.removeAttribute( 'sqlOptName' );
    					}
    				},
                        {
    					id: 'sqlOptValue',
    					...
    					setup: function( name, element ) {
                            if ( name == 'clear' )
                                ...
                                this.setValue( element.data( 'cke-saved-sqlOptValue' ) || element.getAttribute( 'sqlOptValue' ) || '' );
        					}
    					},
    					commit: function( element ) {
    						if ( this.getValue() )
    							element.setAttribute( 'sqlOptValue', this.getValue() );
    						else
    							element.removeAttribute( 'sqlOptValue' );
    					}
    				}
    				]
    			},
    				...
    				setup: function( name, element ) {
    				    if ( name == 'clear' )
    						...
    						this.setValue( element.data( 'cke-saved-sql' ) || element.getAttribute( 'sql' ) || '' );
    					}
    				},
					commit: function( element ) {
						if ( this.getValue() )
