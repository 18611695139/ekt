...
this.imagePreview=function(d,c){
	...
	$(c).hover(function(e){
		$("body").append("<div id='preview' style='position:absolute;border:1px solid #dadade;background:#95959d;padding:5px;display:none;color:#fff;text-align:center;z-index:99998;'><img id='pi' src='image/loadingAnimation.gif' alt='Now Loading' /></div>");
