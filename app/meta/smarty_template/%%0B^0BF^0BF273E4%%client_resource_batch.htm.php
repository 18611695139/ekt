<?php /* Smarty version 2.6.19, created on 2015-08-07 09:28:17
         compiled from client_resource_batch.htm */ ?>
...
<div style='padding-top:5px;'>
 满足搜索条件数据有 <span style='color:blue;'><?php echo $this->_tpl_vars['total']; ?>
</span>&nbsp;条,<span style='font-weight:bold;'>可分配的数据</span>有 <span id='total_num' style='color:red;'><?php echo $this->_tpl_vars['batch_total']; ?>
</span>&nbsp;条（可分配数据：指 本部门(不包括子部门)，还没指定所属人的数据）。
...
$(document).ready(function() {
	...
	$('#dept_user_list').treegrid({
		...
		{title:'还可分配数量',field:'data_amount',width:120,formatter:function(value,rowData,rowIndex){
			if(rowData.id == <?php echo $this->_tpl_vars['dept_session_id']; ?>
){
				return '-';
			}
...
function client_batch_deployment()
{
	...
	$.ajax({
		...
		data: {'search_condition':'<?php echo $this->_tpl_vars['search_condition']; ?>
',"assign_str":assign_str,"total_limit":assign_total,"special_deploy":special_deploy},
		dataType: "json",
