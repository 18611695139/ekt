<?php /* Smarty version 2.6.19, created on 2015-07-21 11:12:15
...
<table id="_table_field_confirm_<?php echo $this->_tpl_vars['field_type']; ?>
" cellspacing="0" cellpadding="0" align="center" style="width:99%;border-collapse: collapse; border: 0px solid gray;" >
<tbody>	
...
" maxlength="25" value="<?php echo $this->_tpl_vars['field_info']['name']; ?>
" <?php if ($this->_tpl_vars['field_info']['state'] == 0): ?> readonly <?php endif; ?> />
        <span class="easyui-tooltip add-on" title="自定义字段 - 详细设置" onclick="_set_options('<?php echo $this->_tpl_vars['field_info']['id']; ?>
');" >
...
<button class="btn btn-primary" onclick="_add_field();" id="_field_add_row_<?php echo $this->_tpl_vars['field_type']; ?>
" title="添加新字段">
    <span class="glyphicon glyphicon-plus"></span> 添加
</button>
<button class="btn btn-primary" onclick="_delete_field();" id="_field_del_row_<?php echo $this->_tpl_vars['field_type']; ?>
" title="删除最后一行">
    <span class="glyphicon glyphicon-minus"></span> 删除
</button>
<button class="btn btn-primary" onclick="_save_field();" id="_field_confirm_save_<?php echo $this->_tpl_vars['field_type']; ?>
" title="确定 - 保存配置">
