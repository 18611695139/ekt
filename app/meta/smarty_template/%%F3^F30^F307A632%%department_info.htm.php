<?php /* Smarty version 2.6.19, created on 2015-07-21 11:11:52
         compiled from department_info.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'department_info.htm', 178, false),)), $this); ?>
<?php if (! $this->_tpl_vars['setting_department']): ?>
...
$(function(){
	...
	$('#dept_tree').tree({
		...
		onLoadSuccess:function(){
			var select_name = "";
			<?php if ($this->_tpl_vars['session_dept_id']): ?>
			var node = "";
			if( tmp_select_dept == 0 )
			{
				node = $('#dept_tree').tree('find', "<?php echo $this->_tpl_vars['session_dept_id']; ?>
");
			}
			else
			{
...
function add_dept()
{
	...
	if(dept_p_deep+1 > <?php echo ((is_array($_tmp=@$this->_tpl_vars['max_tree_deep'])) ? $this->_run_mod_handler('default', true, $_tmp, 6) : smarty_modifier_default($_tmp, 6)); ?>
)
	{
...
function del_dept()
{
	...
	<?php if ($this->_tpl_vars['session_dept_id']): ?>
	if( '<?php echo $this->_tpl_vars['session_dept_id']; ?>
' == dept_id )
	{
